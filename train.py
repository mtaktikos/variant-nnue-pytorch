...
def main():
  ...
  parser.add_argument("--lambda", default=0.25, type=float, dest='lambda_', help="lambda=1.0 = train on evaluations, lambda=0.0 = train on game results, interpolates between (default=1.0).")
